...
instance (priority := 50) instNormedAddCommGroupOfOps {R E} [NormedAddGroupOps R E]
...
instance (priority := 50) instNormedCommGroupOfOps {R E} [NormedGroupOps R E]
    [LawfulDataNormedGroupOps E] [LawfulNormedGroupOps E] : NormedCommGroup E where
  dist_eq := LawfulNormedGroupOps.dist_eq

instance (priority := 100) instNormedAddMonoidOpsOfNormedAddCommGroup {E : Type v}
    [inst : NormedAddCommGroup E] : NormedAddMonoidOps ℝ E where
  rnorm x := ‖x‖
  nsmul := inst.nsmul

instance (priority := 100) instLawfulDataNormedAddMonoidOpsOfNormedAddCommGroup
    {E : Type v} [inst : NormedAddCommGroup E] : LawfulDataNormedAddMonoidOps E where
  requiv := Equiv.refl ℝ
  rnorm_eq_norm _ := rfl

instance (priority := 100) instLawfulNormedAddMonoidOpsOfNormedAddCommGroup {E : Type v}
...
instance (priority := 100) instNormedAddGroupOpsOfNormedAddCommGroup {E : Type v}
    [inst : NormedAddCommGroup E] : NormedAddGroupOps ℝ E where
  rnorm x := ‖x‖
  zsmul := inst.zsmul

instance (priority := 100) instLawfulDataNormedAddGroupOpsOfNormedAddCommGroup {E : Type v}
    [inst : NormedAddCommGroup E] : LawfulDataNormedAddGroupOps E where
  requiv := Equiv.refl ℝ
  rnorm_eq_norm _ := rfl

instance (priority := 100) instLawfulNormedAddGroupOpsOfNormedAddCommGroup {E : Type v}
...
instance (priority := 100) instNormedMonoidOpsOfNormedCommGroup {E : Type v}
    [inst : NormedCommGroup E] : NormedMonoidOps ℝ E where
  rnorm x := ‖x‖
  npow := inst.npow

instance (priority := 100) instLawfulDataNormedMonoidOpsOfNormedCommGroup {E : Type v}
    [inst : NormedCommGroup E] : LawfulDataNormedMonoidOps E where
  requiv := Equiv.refl ℝ
  rnorm_eq_norm _ := rfl

instance (priority := 100) instLawfulNormedMonoidOpsOfNormedCommGroup {E : Type v}
...
instance (priority := 100) instNormedGroupOpsOfNormedCommGroup {E : Type v}
    [inst : NormedCommGroup E] : NormedGroupOps ℝ E where
  rnorm x := ‖x‖
  zpow := inst.zpow

instance (priority := 100) instLawfulDataNormedGroupOpsOfNormedCommGroup {E : Type v}
    [inst : NormedCommGroup E] : LawfulDataNormedGroupOps E where
  requiv := Equiv.refl ℝ
  rnorm_eq_norm _ := rfl

instance (priority := 100) instLawfulNormedGroupOpsOfNormedCommGroup {E : Type v}
